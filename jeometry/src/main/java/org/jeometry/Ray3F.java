...
public final class Ray3F {
   ...
   */
  public static Ray3F fromOriginAndDirection(Vector3F origin, Vector3F direction) {
    return new Ray3F(origin, direction.normalized());
  }

  public Vector3F getPoint(float distanceFromOrigin) {
